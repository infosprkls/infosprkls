...
@section('content')
    <div class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('companyattachments.update', $attachment) }}" autocomplete="off" class="form-horizontal"  enctype="multipart/form-data">
                        @csrf
                        @method('put')
                            ...
                            <div class="card-body ">
                                <div class="row">
                                    <div class="col-md-12 text-right">
                                        <a href="{{ route('company-documents',$companyinfo->id) }}"
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}"
                                                   ...
                                                   placeholder="{{ __('Title') }}" value="{{$attachment->title}}" required/>
                                            @if ($errors->has('title'))
                                ...
                                <div class="row mx-0">
                                  <div class="col-12">
                                    <div class="dropzone-wrapper">
                                       ...
                                       <input type="file" name="file-upload" id="file-upload" class="dropzone" accept="image/*,.pdf,.doc,.docx,.xml,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document">
                                    </div>
