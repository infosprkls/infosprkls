		...
		<div id="ModalDayExtra" class="modal" data-day="" data-task="">
		  ...
		  <div class="modal-content">
		  	<div class="modal-header">
		        <h5 class="modal-title" id="task_title_heading">Modal title</h5>
			...
			<div class="form-group">
				<div class="row">
					...
					<div class="col-2"></div>
					<div class="col-4">
						<input type="text" id="day-extra-github" placeholder="Github Repo Link:" style="width: 100%"/>
					</div>
					<div class="col-2">
						<button id="day-extra-open-github" class="btn btn-primary" style="margin-top: -5px">Open Link</button>
					</div>
					<div class="col-1"></div>
				</div>
				<div class="row">
					<div class="col-3">
						...
						<div class="row">
							<div class="col-12" id="day-extra-attachments-container" style="overflow-y: scroll">
							</div>
						</div>
					</div>
					<div class="col-2"></div>
				...
				<div class="row">
					...
					<div class="col-2">
						<button id="day-extra-save" class="btn btn-primary" style="width: 100%">Save</button>
					</div>
					<div class="col-2">
						<button id="day-extra-cancel" class="btn btn-primary" style="width: 100%">Cancel</button>
					</div>
					<div class="col-1"></div>
				</div>
			</div>
...
@section('page-script')
    ...
    <script>
    	...
    	$('#day-extra-date').keydown(function(e) {
			...
			var current_month = {{ Request::segment(3) ? Request::segment(3) : $months->current_month }};
			var current_year = {{ Request::segment(4) ? Request::segment(4) : $months->current_year }};
            ...
            function registerListeners(){
				...
				$('#day-extra-open-github').click(function(){
					if($('#day-extra-github').val() != ""){
						var win = window.open($('#day-extra-github').val(), '_blank');
						if (win) {
			...
			function displayExtraDayAttachments(task, day){
				console.log("displaying attachments for" + task + day);
									...
									if(i == 0){
										...
										`;
											if(month.tasks[i].duplicate!='done'){
												html += `
												<a class="add_task_title" style="font-size: 12px;" data-title="`+month.tasks[i].title+`" data-duplicate="`+month.tasks[i].duplicate+`" data-number="`+i+`" data-month="`+month.month+`" data-year="`+month.year+`">+</a>`;
											}
											html += `
											<input type="text" name="task-title[]" id="task-title" class="form-control task-title" style="font-size: 11px;margin-left: 4px;"
