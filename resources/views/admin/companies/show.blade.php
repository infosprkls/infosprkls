                ...
                <div class="card">
                    ...
                    <div class="card-header card-header-primary d-flex flex-wrap align-items-center">
                        ...
                        <div class="ml-auto content-right content-btn-4">
                            <a class="btn btn-secondary btn-custom tooltiped"
                                href="{{route('company-documents',$company->id)}}">
                            ...
                            <a class="btn btn-secondary btn-custom tooltiped"
                                href="{{route('company-invoice',$company->id)}}">
                                <i class="material-icons">assignment</i>
                                <span>
                                    {{ __('Invoices') }}
                                </span>
                            ...
                            <a class="btn btn-secondary btn-custom tooltiped"
                                href="{{route('company-pdf',$company->id)}}">
                                <i class="material-icons">assignment</i>
                                <span>
                                    {{ __('View Services') }}
                                </span>
                            ...
                            <a class="btn btn-secondary btn-custom tooltiped"
                                href="{{route('company.user.create',$company->id)}}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div
                                class="col-xl-4 col-lg-4 col-md-3 col-sm-4 col-12 col-form-label align-self-center pb-xs-0">
                                <label for="">{{__("Name:")}}</label>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-8 col-12  align-self-center">
                                <h4>{{$company->name}}</h4>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-8 col-12  align-self-center">
                                <div style="border: 1px solid #000;padding: 10px; font-weight: bold; font-style: 14px">
                                    <center><b style="font-size: 18px"><u>Description</u></b></center>
                                    {{$company->description}}
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-8 col-12  align-self-center">
                                <h4>{{$company->alias?$company->alias:'N/A'}}</h4>
                            </div>
                        </div>
                        <div class="row">
                            <div
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-8 col-12  align-self-center">
                                <h4>
                                    <?php  echo ($company->hour_type == "round")?"Full Hour":"Decimal";?>
                                </h4>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row border-bottom">
                            <div
                                class="col-xl-4 col-lg-4 col-md-3 col-sm-4 col-12 col-form-label align-self-center pb-xs-0">
                                <label for="">{{__("Linkedin Address:")}}</label>
                            </div>
                            <div class="col-lg-7 col-md-7 col-sm-8 col-12  align-self-center">
                                <h4>{{$company->linkdin_address}}</h4>
                            </div>
                        </div>
                        <div class="row border-bottom">
                            <div
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 col-sm-8 col-12  align-self-center">
                                <h4>
                                    <a
                                        href="{{route('companies.show',$company->createdBy == null ? 1 : $company->createdBy->id)}}">{{$company->createdBy
                                        == null ? "Unknown" : $company->createdBy->username}}</a>
                                </h4>
                            </div>
                        </div>
                        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-12 col-12">
                <div class="card custom-card-width">
                    <img class="card-img-top"
                        src="{{$company->logo == 'logo.png' ? asset('logo.png') : asset('/public/bigstorage/'.$company->logo)}}"
                        alt="Company Logo">
                </div>
            </div>
        </div>
