...
class Mdl_Payments extends Response_Model
{
    ...
    public function db_array()
    {
        ...
        if(isset($_REQUEST['required_amount']))
        {
            $db_array['required_amount'] = standardize_amount($_REQUEST['required_amount']);
        }

        if(isset($_REQUEST['payment_due_date']))
        {
            $db_array['payment_due_date'] = ($_REQUEST['payment_due_date']);
        }
