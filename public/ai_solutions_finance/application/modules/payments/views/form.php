<script>
    $(function () {
        ...
        ?>
        setTimeout(function(){
            $("#invoice_id").parent("div").find(".select2").addClass("disable_field");
        },500)
        <?php 
        }
        ?>
    ...
    <div id="content">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <select name="invoice_id" id="invoice_id" class="form-control simple-select <?=($is_tracker == 1 ? 'disable_field1' : '')?>">
                    <?php if (!$payment_id) { ?>
            ...
            <div class="col-xs-12 col-sm-6">
                <div class="input-group">
                    <input name="payment_date" id="payment_date"
                           ...
                           value="<?php echo date_from_mysql($is_tracker == 0 ? $this->mdl_payments->form_value('payment_date') : date('Y-m-d')); ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-12 col-sm-6">
                <input type="text" name="payment_amount" id="payment_amount" class="form-control <?=($is_tracker == 1 ? 'disable_field' : '')?>"
                       value="<?php echo format_amount($this->mdl_payments->form_value($is_tracker == 0 ? 'payment_amount' : 'required_amount')); ?>">
            </div>
        </div>
