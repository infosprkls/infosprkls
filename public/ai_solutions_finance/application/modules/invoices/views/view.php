    ...
    $(function () {
        ...
        $('#btn_save_invoice').click(function () {
            ...
            var items = [
                {
                    "invoice_id": <?php echo $invoice_id; ?>,
                    "item_id": $("#invoice_total_amount").attr("item_id"),
                    "item_product_id": "",
                    "item_task_id": "",
                    "item_name": $("#invoice_category").val(),
                    "item_quantity": "1",
                    "item_price": $("#invoice_total_amount").val(),
                    "item_discount_amount": "",
                    "item_tax_rate_id": "0",
                    "item_description": "",
                    "item_product_unit_id": "0",
                    "item_order": 1
                }
            ]
            ...
            $.post("<?php echo site_url('invoices/ajax/save'); ?>", {
                    ...
                    num_of_instalments: $('#invoice_num_of_instalments').val(),
                    instalment_price: $('#invoice_instalment_price').val(),
                    invoice_category: $('#invoice_category').val(),
                    instalment_description: $('#invoice_description').val(),
                ...
                function (data) {
                    ...
                    {
                        var instalment_amount = response.instalment_amount;
                        if($("#invoice_total_amount").attr("item_id") == "" && instalment_amount > 0)
                        {
                            var instalment_due_dates = response.instalment_due_dates.split(",");

                            createInstalment(0,<?php echo $invoice_id; ?>,$('#invoice_date_created').val(),instalment_amount,instalment_due_dates,function()
                            {
        ...
        function createInstalment(count,invoice_id,date_created,instalment_amount,instalment_due_dates,callback)
        {
            $.post("<?php echo site_url('payments/ajax/add'); ?>", 
            {
                    invoice_id: invoice_id,
                    payment_amount: 0,
                    required_amount:instalment_amount,
                    payment_method_id: 0,
                    payment_date: date_created,
                    payment_note: '',
                    payment_due_date: instalment_due_dates[count]
                }, 
                function (data) 
                { 
                    if(count < (instalment_due_dates.length - 1))
                    {
                        count ++;
                        createInstalment(count,invoice_id,date_created,instalment_amount,instalment_due_dates,callback)
                    }
                    else
                    {
                        callback();
...
$(document).on("keyup","#invoice_total_amount,#invoice_num_of_instalments",function(){
    var amount = $("#invoice_total_amount").val();
    var instalments = $("#invoice_num_of_instalments").val();
    
    var price = "";
    if(amount != "" && instalments != "")
    {
        amount = parseFloat(amount);
        instalments = parseInt(instalments);
        price = amount / instalments;
    }

    $("#invoice_instalment_price").val(price);
})

/*$(document).on("keydown","#invoice_instalment_price",function(){
    return false;
})*/
</script>
<style type="text/css">
                    ...
                    <div class="details-box panel panel-default panel-body">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                ...
                                <div class="invoice-properties" style="display: none">
                            ...
                            <div class="col-xs-12 col-md-6">
                                ...
                                <div class="invoice-properties">
                                    ...
                                    <input type="text" list="categories" class="form-control input-sm" id="invoice_category" value="<?php _htmlsc($invoice->invoice_category); ?>">
                            ...
                            <div class="col-xs-12 col-md-6">
                                ...
                                {
                                    // print_r($items[0]);
                                    $calc_amount = $items[0]->item_price;
                                    $calc_item_id = $items[0]->item_id;

                                    // echo "price == ".$price;
                                }
                                ?>
                                        <label>Amount</label>
                                        <input type="number" id="invoice_total_amount" class="form-control input-sm" name="item_price" item_id="<?php echo $calc_item_id; ?>"
                                               value="<?php echo $calc_amount; ?>"
                                            <?php if ($invoice->is_read_only == 1) {
                                                echo 'disabled="disabled"';
                                            } ?>>
                                </div>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="invoice-properties">
                                    <label>Num of Instalments</label>
                                    <input type="number" id="invoice_num_of_instalments" class="form-control input-sm"
                                           value="<?php _htmlsc($invoice->num_of_instalments); ?>"
                                        <?php if ($invoice->is_read_only == 1) {
                                            echo 'disabled="disabled"';
                                        } ?>>
                                </div>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="invoice-properties">
                                        <label>Price</label>
                                        <input type="number" tabindex="-1" id="invoice_instalment_price" class="form-control input-sm disable_effect"
                                               value="<?php echo $invoice->instalment_price; ?>"
                                            <?php if ($invoice->is_read_only == 1) {
                                                echo 'disabled="disabled"';
                                            } ?>>
                                </div>
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="invoice-properties">
                                        ...
                                        <textarea class="form-control input-sm" id="invoice_description" style="height: 100px"><?php echo $invoice->instalment_description; ?></textarea>
