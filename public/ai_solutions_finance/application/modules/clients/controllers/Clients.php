...
class Clients extends Admin_Controller
{
    ...
    public function view($client_id)
    {
        ...
        //$this->mdl_payments->by_client($client_id)->where(' ip_payments.required_amount = ip_payments.payment_amount or ip_payments.required_amount = 0 ')->limit(20)->get()->result(),
        ...
        $this->layout->set(
            array(
                ...
                'payments' => $this->mdl_payments->where(' (ip_payments.required_amount = ip_payments.payment_amount or ip_payments.required_amount = 0) and ip_clients.client_id = '.$client_id)->limit(20)->get()->result(),
                'custom_fields' => $custom_fields,
